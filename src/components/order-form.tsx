    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                >
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    ...
                    <FormLabel className="font-normal">
                      Criação (Música totalmente nova, do zero)
                    </FormLabel>
                  </FormItem>
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    <FormControl>
                      <RadioGroupItem value="recreation" />
                    </FormControl>
                    <FormLabel className="font-normal">
                      Re-Criação (Baseado em uma paródia ou forte inspiração)
                    </FormLabel>
                  </FormItem>
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    <FormControl>
                      <RadioGroupItem value="instrumental" />
                    </FormControl>
                    <FormLabel className="font-normal">Instrumental (Beat ou arranjo para sua letra)</FormLabel>
                  </FormItem>
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    <FormControl>
                    ...
                    <FormLabel className="font-normal">
                      Produção Completa (Você já tem a letra e melodia)
                    </FormLabel>
                  </FormItem>
                </RadioGroup>
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  placeholder="Conte-nos sobre a mensagem da música, artistas de referência, e qualquer detalhe que ajude a dar vida à sua ideia."
              ...
              <FormControl>
                ...
                >
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    ...
                    <FormLabel className="font-normal">
                      Uso Pessoal (Devocional, toque de celular, etc.)
                    </FormLabel>
                  </FormItem>
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    <FormControl>
                      <RadioGroupItem value="church" />
                    </FormControl>
                    <FormLabel className="font-normal">
                      Ministério (Uso na igreja, pequenos grupos)
                    </FormLabel>
                  </FormItem>
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    <FormControl>
                    ...
                    <FormLabel className="font-normal">
                      Uso Comercial (Lançamento em plataformas digitais, rádio, etc.)
                    </FormLabel>
                  </FormItem>
                </RadioGroup>
              </FormControl>
        ...
        <Button type="submit" size="lg" className="w-full font-bold" disabled={isSubmitting}>
          {isSubmitting ? 'Enviando...' : <><Send className="mr-2 h-4 w-4" /> Comece a Conversa</>}
        </Button>
      </form>
    </Form>
  );
