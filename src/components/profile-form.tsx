...
import { generateBio, GenerateBioInput } from "@/ai/flows/bio-flow";
...
export function ProfileForm() {
  ...
  const handleGenerateBio = () => {
    ...
    if (!artistName) {
        toast({
            ...
            description: "Por favor, preencha seu nome artístico para gerar a biografia.",
            variant: "destructive"
        });
        return;
    }
    ...
    startAiTransition(async () => {
        try {
            const input: GenerateBioInput = {
                artistName,
                preferredStyle: preferredStyle || 'Gospel',
                preferredRhythm: preferredRhythm || 'Inspirador'
            };
            ...
            if (result.bio) {
                ...
                toast({
                    ...
                    description: "Sua nova biografia está pronta para ser usada."
                })
            }
        } catch (error) {
            ...
            toast({
                ...
                description: "Não foi possível gerar a biografia. Tente novamente.",
                variant: "destructive"
            });
        }
    });
  ...
  if (!user) {
      return <LoggedOutView onGoogleLogin={signInWithGoogle} onAppleLogin={signInWithApple} />;
  }
  ...
  return (
    <div className="space-y-12">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Isso nos ajuda a entender seu estilo e agilizar novos pedidos.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
            <h2 className="text-2xl font-bold font-headline">Ações da Conta</h2>
